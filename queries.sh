...
echo "$($PSQL "select t.name from games g right join teams t on g.winner_id = t.team_id or g.opponent_id = t.team_id where year = 2014 and round = 'Eighth-Final' order by name")"
